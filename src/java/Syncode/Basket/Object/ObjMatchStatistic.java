...
public class ObjMatchStatistic {
    ...
    public JSONObject toJson(){ 
         ...
         json.put("team1","<a href='#' onclick=teamdetail('"+team1+"')><img src='../img/Team/Logo/"+logo1+"' width='30px' height='30px'> "+team1+"</a>");
         json.put("pts1", pts1);
         json.put("team2","<a href='#' onclick=teamdetail('"+team2+"')><img src='../img/Team/Logo/"+logo2+"' width='30px' height='30px'> "+team2+"</a>");
         json.put("pts2", pts2);
          return json;
    }
