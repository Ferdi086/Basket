 ...
 * @author meiiko
 */
public class NewsB extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       HashMap tm = dh.getNews();
       request.setAttribute("News",tm);
       request.getRequestDispatcher("/BackEnd/news.jsp").forward(request,response);
    }
