			...
			<div class="wthree_team_grids">
				...
				<div class="col-md-3 wthree_team_grid">
                                        ...
                                        <div class="hovereffect" onclick="playdetail(${item.value.idPemain})">
                                            <img src="../img/Players/${item.value.foto}" alt="${item.value.namaPemain}" onerror="this.onerror=null;this.src='../img/Players/nopic.png';" width="400px" height="400px" class="img-responsive" />
                                            <div class="overlay">
