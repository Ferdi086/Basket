    ...
    <body>
        ...
        <div class="left-menu">
			...
			<span class="text">Season</span>
                ...
                <li> 
                    <a href="News" >
			<img class="icon" src="../img/news.png">
                    ...
                    <table id="player" class="table table-condensed table-striped" data-toggle="table" data-search="true" data-page-list="[20, 25, 50, 100, ALL]" data-pagination="true">
                        <thead>
                            ...
                            <c:forEach var="item" varStatus="loopCounter" items="${requestScope.News}">
                                ...
                                <c:set var="deskripsi" value="${item.value.deskripsi}" />
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: middle;text-align: center"> ${deskripsi}</td>
                                ...
                                <td style="vertical-align: middle;text-align: center"> 
                                    <button class="btn btn-warning button" data-target="#updatemodal" data-toggle="modal" onclick="Update('${idnews}','${judul}','${tanggal}','${deskripsi}','${foto}')"><span class="glyphicon glyphicon-edit"></span></button>
                                        <c:choose>
                ...
                <div class="modal-body">
                    <form class="form-horizontal" method="post" action="doUpdatePlayer" id="formUpdate" enctype = "multipart/form-data" >
                        ...
                        <div class="form-group">
                                   <label class="control-label col-sm-2" >Image News</label>
                                   <div class="col-sm-3">
                                       <input type="file" name="ufile" id="updatefile" accept=".jpg, .jpeg, .png" onchange="readURL(this);" required/>
                                   </div> 
                                   <label class="col-sm-2 control-label">Preview</label>
                                    <div class="col-sm-4" style="background-color: whitesmoke;height:140px;width:135px;margin-left:50px">
                                        <img id="updatepreview" style="margin-left:-15px" src="../img/nopic.png" width="135px" height="140px"/>
                                    </div>
                        </div>
                            <div class="form-group">
                                   <label class="control-label col-sm-2" >News Content</label>
...
<!-- Modal Konfirmasi Update-->
    ...
    <script>
        ...
        }    '${idnews}','${judul}','${tanggal}','${deskripsi}','${foto}')
        function Update(idnews,judul,tanggal,deskripsi,foto){  
        $("#updateid_pemain").val(idnews);
